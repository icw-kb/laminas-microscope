        ...
        return array_merge([
            'laminas_microscope' => [
                ...
                'collector_mapping' => [
                    ...
                    'config'   => [
                        'class'        => \LaminasMicroscope\Collector\LaminasConfigCollector::class,
                        'factory'      => 'service',
                        'service_name' => \LaminasMicroscope\Collector\LaminasConfigCollector::class,
                    ],
                    'pdo'      => [
                        'class'        => \LaminasMicroscope\Collector\PDOCollector::class,
                        'factory'      => 'service',
                        'service_name' => \LaminasMicroscope\Collector\PDOCollector::class,
                    ],
                    'request'  => [
                        'class'        => \LaminasMicroscope\Collector\LaminasRequestCollector::class,
                        'factory'      => 'service',
                        'service_name' => \LaminasMicroscope\Collector\LaminasRequestCollector::class,
                    ],
                ],
            ],
        ], $config);
